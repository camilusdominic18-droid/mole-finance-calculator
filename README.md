...
![Logo](docs/BusinessProfile.docx) <!-- Replace with actual logo image if available -->
...
def generate_repayment_pdf(filename):
    ...
    # Generate repayment data for loans from 50 to 3000
    y -= 30
    for loan in range(50, 3001, 50):  # step by 50
        interest_rate = 0.50  # 50% for 4 paydays
